...
data = pandas.read_csv('../bag_of_bags/data.csv', header=None).values
ids = pandas.read_csv('../bag_of_bags/ids.csv', header=None).values
labels = pandas.read_csv('../bag_of_bags/labels.csv', header=None).values.reshape(-1)
